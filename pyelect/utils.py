...
def write_yaml_with_header(data, path, file_type=None, stdout=None):
    _fix_header(data, file_type=file_type)
...
def _fix_header(data, file_type):
    try:
        meta = data[KEY_META]
    except KeyError:
        meta = {}
    ...
    auto_comments = {
        FILE_AUTO_GENERATED:
            "WARNING: normalization will remove YAML comments.",
        FILE_AUTO_UPDATED:
    ...
    if auto_comment:
        meta['_auto_comment'] = auto_comments[file_type]
